...
useSeoMeta({
  ...
  ogDescription: 'Privacy policy for AnimeVerse',
  ogImage: 'logo.png',
  ogUrl: '[og:url]',
  twitterTitle: 'Home',
  twitterDescription: 'Privacy policy for AnimeVerse',
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to AnimeVerse.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to AnimeVerse, accessible from
            <a
